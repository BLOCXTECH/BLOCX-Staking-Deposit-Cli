...
BlocxSetting = BaseChainSetting(
    NETWORK_NAME='blocx', GENESIS_FORK_VERSION=bytes.fromhex('10000001'),
    GENESIS_VALIDATORS_ROOT=bytes.fromhex('8febbfdcfa59984389d63b08f44b7710a3f008b6a7d9a1f41103d816777b799d'))
...
def get_chain_setting(chain_name: str = BLOCX) -> BaseChainSetting:
